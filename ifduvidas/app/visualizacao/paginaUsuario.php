...
<?php include'menu.php' ?>
       ...
       <?php if ($cod_tip == '5') { ?>
       	...
       	<div class="ui horizontal section divider" id="gambiarra">Perguntas feitas por <?=$usuario['Nome']?></div>
	...
	<?php }} ?>
       	...
       	<div class="ui horizontal section divider" id="gambiarra">Perguntas respondidas <?=$usuario['Nome']?></div>
      <div class="ui vertically divided grid">
